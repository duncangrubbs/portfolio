      ...
      <div className="home__grid-item">
        <div className="glass-container">
          ...
          <p>
            ...
            build <a href="https://www.flowlie.com">Flowlie</a>, an early stage
            startup creating the next generation of data infrastructure for
            venture fundraising. I love working on side projects and have
            experience with&nbsp;
            <a
            ...
            . Outside of programming I enjoy UI design, DJing, cooking, and
            backpacking. You can find me on&nbsp;
            <a rel="noopenner external" href="https://github.com/duncangrubbs">
              Github
            </a>
            &nbsp;and&nbsp;
            <a
        ...
        <div className="portfolio__content">
          <Link to="/portfolio/barterout" className="glass-container">
            ...
            <p>
              ...
              used textbook transactions easier. For the last year, I have
              worked in a small team building the client-side of the site, as
              well as the API (backend) infrastructure.
            </p>
          </Link>
          ...
          <Link to="/portfolio/letsgo" className="glass-container">
            <h2>Let&apos;s Go</h2>
            <p>
              Recently, I returned to a project I had started a few years ago
              with the hope of rebuilding the API in a more robust, clean way,
              while still retaining the ideas I had about the app in the first
              place. I wanted to work in a test driven way, focusing on making
              my code clean and testable.
            </p>
          </Link>
        </div>
      </div>
