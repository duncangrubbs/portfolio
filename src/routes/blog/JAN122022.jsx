  ...
  <div>
    <div className="portfoliopage__content--article">
      ...
      <p className="writing__para">
        ...
        <a href="https://www.flowlie.com">Flowlie</a> since January of 2021 and
        it has been an incredible learning experience. Our entire stack is
        written in Typescript (React and Express) and we use MongoDB for our
        database. One issue that we were running into quite often is that when
        we were sending dates from our frontend to our API and vice versa they
        we getting serialized as strings. So for example, on our frontend we
        would initialize a date when someone updated a fundraising round using{' '}
        <code>new Date()</code> and then store it in some object and hand it off
        to the API via <code>POST</code> request. However, the backend would see
        something like this <code>2022-01-12T23:54:34.574Z</code>.
      </p>
      <p className="writing__para">
        ...
        <a href="https://expressjs.com/">Express.js</a> has a super nice
        middleware feature that allows you to intercept requests and do
        something to them before passing them off to the next handler.{' '}
      ...
      <p className="writing__para">
        ...
        introduced <a href="https://github.com/duncangrubbs/ozzy">ozzy</a>.
