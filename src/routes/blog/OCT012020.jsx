...
const OCT012020 = () => (
  <div>
    ...
    <div className="portfoliopage__content--article">
      ...
      <p className="writing__para">
        The solution I found is to create a few new files. This solution is not dependent on using React, as
        these will be plain vanilla Javascript files. One will act as a <code>FetchService</code>. This
        can be thought of the orchestrator, all requests will pass through this. Here you will declare your
        <code>fetch</code> function that will override the default one, this way you can have headers hardcoded
        to standardize all of the requests you are making. Of course if we need the option of changing them,
      ...
      <p className="writing__para">
        Another file would be a <code>ErrorService</code>. This will be used by the FetchService to handle
        errors if they arise. In the <code>FetchService</code>, your overridden <code>fetch</code> method
